...
# Default config
# =========================
CONFIG="configs/eeg/ubp_zca_qr_img_eegprj.yaml"
PY="python"
SCRIPT="main_barlow_text_zca_qr_img_eegprj_cca_attn_dis_t.py"

# BRAIN_BACKBONE="EEGProjectLayer"
# BRAIN_BACKBONE="TSconv"
# BRAIN_BACKBONE="EEGnet"
# BRAIN_BACKBONE="RefineModel"
# BRAIN_BACKBONE="Shallownet"
# BRAIN_BACKBONE="Deepnet"
